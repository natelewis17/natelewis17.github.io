...
<img src="{{site.url}}/{{site.baseurl}}/assets/images/p_20.png" alt="" style="width:800px;"/>
...
The JLPT is a common resource that students use to guide their progression thorugh learning vocabulary, grammar, and ocfourse kanji as well. It is important to note that no official list exists of what kanji goes with which level of the JLPT and so assignment of level is based purely on historic trend. As is well known, the JLPT does not evenly distribute kanji across all levels. As we can see below, the N1 and N2 levels require a dramatic increase in kanji knowledge.
